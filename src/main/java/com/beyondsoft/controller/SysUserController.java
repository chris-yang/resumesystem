...
public class SysUserController {
     ...
     * @return
     */
    @SysOperLogAnno(logType=200,module="用户管理 ",methods="进入用户管理页面")
...
//        return new PageData(page.getTotal(), page.getRecords());
     ...
     * @return
     */
    @SysOperLogAnno(logType=200,module="用户管理 ",methods="添加用户")
     ...
     * @return
     */
    @SysOperLogAnno(logType=200,module="用户管理 ",methods="修改用户")
     ...
     * @return
     */
    @SysOperLogAnno(logType=200,module="用户管理 ",methods="删除用户")
     ...
     * @return
     */
    @SysOperLogAnno(logType=200,module="用户管理 ",methods="重置密码")
     ...
     * @return
     */
    @SysOperLogAnno(logType=200,module="用户管理 ",methods="修改密码")
     ...
     * @return
     */
    @SysOperLogAnno(logType=200,module="用户管理 ",methods="启用用户")
     ...
     * @return
     */
    @SysOperLogAnno(logType=200,module="用户管理 ",methods="停用用户")
     ...
     * @return
     */
    @GetMapping("/sys-user/dept/users/{userId}/{roleCode}")
    public Result getUsers(@PathVariable Integer userId,@PathVariable String roleCode) {
        return this.sysUserService.getUsersByDeptIdAndRoleCode(userId,roleCode);
    }
    /**

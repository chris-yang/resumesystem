...
public enum HttpResultEnum {
    ...
    PG_STOP_CODE_500("500","项目组下有入场员工，不能停用"),
    PG_ASSISTANT_0("0","项目组未关联助理，不能启用"),
    PG_SETTLEMENT_0("0","项目组未关联结算负责人，不能启用"),
    //角色编码
    ...
    SETTLE_CODE_500("settle_500","生成结算单失败"),
    SETTLE_CODE_200("settle_200","生成结算单成功"),
